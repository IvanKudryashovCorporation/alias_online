...
# Voice/mic
# Dedicated voice polling is much more frequent than room-state polling
# to avoid 1s chunk bursts and "bubbling" playback artifacts.
VOICE_POLLING_INTERVAL_SECONDS = _env_float("VOICE_POLLING_INTERVAL_SECONDS", 0.12)
VOICE_POLLING_ERROR_BACKOFF_FACTOR = _env_float("VOICE_POLLING_ERROR_BACKOFF_FACTOR", 1.25)
VOICE_POLLING_MAX_BACKOFF_SECONDS = _env_float("VOICE_POLLING_MAX_BACKOFF_SECONDS", 1.0)
VOICE_POLLING_REQUEST_TIMEOUT_SECONDS = _env_float("VOICE_POLLING_REQUEST_TIMEOUT_SECONDS", 1.6)
VOICE_POLLING_INFLIGHT_TIMEOUT_SECONDS = _env_float("VOICE_POLLING_INFLIGHT_TIMEOUT_SECONDS", 2.2)
VOICE_FETCH_MAX_RETRIES = _env_int("VOICE_FETCH_MAX_RETRIES", 0)
VOICE_SEND_REQUEST_TIMEOUT_SECONDS = _env_float("VOICE_SEND_REQUEST_TIMEOUT_SECONDS", 1.2)
VOICE_SEND_MAX_RETRIES = _env_int("VOICE_SEND_MAX_RETRIES", 0)
VOICE_SEND_BATCH_FRAMES = _env_int("VOICE_SEND_BATCH_FRAMES", 3)

# Voice stream defaults tuned for low-latency speech on mobile.
VOICE_SAMPLE_RATE = _env_int("VOICE_SAMPLE_RATE", 16000)
VOICE_BLOCK_FRAMES = _env_int("VOICE_BLOCK_FRAMES", 320)  # 20 ms at 16 kHz
VOICE_PLAY_QUEUE_MAX_FRAMES = _env_int("VOICE_PLAY_QUEUE_MAX_FRAMES", 10)
VOICE_SEND_QUEUE_MAX_FRAMES = _env_int("VOICE_SEND_QUEUE_MAX_FRAMES", 48)
...
REMOTE_WAKE_TOTAL_TIMEOUT_SECONDS = 45
REMOTE_WAKE_PROBE_TIMEOUT_SECONDS = 20
