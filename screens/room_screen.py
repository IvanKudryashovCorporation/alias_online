...
class RoomScreen(Screen):
    ...
    def on_pre_enter(self, *_):
        ...
        # Don't call rejoin here - it's async and can overwrite game state with stale data
        # Rejoin is only used as recovery mechanism in polling when viewer_state is invalid
